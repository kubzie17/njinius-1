...
//   //const baseUrl = `https://api.github.com/repos/njinius/${repo}/stargazers?per_page=${MAX_PER_PAGE}`
...
// const main = async () => {
//  // let repos = await axios.get('https://api.github.com/users/njinius/repos')
...
//    // let { data } = await axios.get(`https://api.github.com/repos/njinius/${name}`)
